import {web3Sign, signEthers, signPolkadot, validateSigPolkadot, signBitcoin, verifyBitcoin} from "../sharedFixtures";
...
describe("Test for verification: verify()", () => {
    ...
    it.each([
        ...
        [signBitcoin, verifyBitcoin as Verifier, "1HZwtseQ9YoRteyAxzt6Zq43u3Re5JKPbk", 0, undefined]
    ])
